...
internal class ChangeDetection_CorrelateByKeyFields_Test : ChangeDetectionTestBase() {
    ...
    inner class PrimeKey {
        ...
        fun testChangeDetection(
            ...
            executeChangeDetectionTest(
                ...
                changeRecordMapper = { changeResults ->
                    changeResults.toKeyFieldsAndChangeKindString()
                }
            )
        }
    }
